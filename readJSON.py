...
def readJSON():
        ...
        if os.path.isfile('SkyWeather2.JSON'):
            ...
            with open('SkyWeather2.JSON') as json_file:
                ...
                config.DustSensorSCL = getJSONValue('DustSensorSCL')
                config.DustSensorSDA = getJSONValue('DustSensorSDA')
                config.DustSensorPowerPin = getJSONValue('DustSensorPowerPin')
                config.GPIO_Pin_PowerDrive_Sig1 = getJSONValue('GPIO_Pin_PowerDrive_Sig1')
                config.GPIO_Pin_PowerDrive_Sig2 = getJSONValue('GPIO_Pin_PowerDrive_Sig2')
